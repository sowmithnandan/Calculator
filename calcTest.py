...
class CalcTest(unittest.TestCase):
    ...
    def TestSqrt(self):
        Choice = 2 
        self.assertEqual(Calculator([4],Choice),2.0,"Answer is 2.0")
        self.assertEqual(Calculator([16],Choice),4.0,"Answer is 4.0")
        self.assertEqual(Calculator([100],Choice),10.0,"Answer is 10.0")
    ...
    def TestFactorial(self):
        ...
        self.assertEqual(Calculator([4],Choice),24,"Answer is 24.0")
        self.assertEqual(Calculator([5],Choice),120,"Answer is 120.0")
    def TestNatLog(self):
        Choice = 4
        self.assertEqual(Calculator([1],Choice),0,"Answer is 0")
